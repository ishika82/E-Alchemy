...
$header = new Header("Terms Of Use", "privacy-terms.css");
$header->output();
...
<p>The E-Alchemy website located at E-Alchemy.com is a copyrighted work belonging to E-Alchemy. Certain features of the
    Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with
    such features.</p>
...
<p>These terms require the use of arbitration Section 10.2 on an individual basis to resolve disputes and also limit the
    remedies available to you in the event of a dispute. These Terms of Use were created with the help of the <a
            href="https://www.termsofusegenerator.net">Terms Of Use Generator</a> and the <a
...
<p><strong>Cookies and Web Beacons.</strong> Like any other website, E-Alchemy uses ‘cookies’. These cookies are used to
    store information including visitors’ preferences, and the pages on the website that the visitor accessed or
    visited. The information is used to optimize the users’ experience by customizing our web page content based on
...
<p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the
    ...
    dispute, and the requested relief.  A Notice to the Company should be sent to: Mumbai . After the Notice is
...
<p>Address: Mumbai </p>
<p>Email: support@e-alchemy.com</p>
<p>Email: support@e-alchemy.com</p>
