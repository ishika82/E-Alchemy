...
$header = new Header("Privacy Policy", "privacy-terms.css");
$header->output();
...
<h1>Privacy Policy for E-Alchemy</h1>

<p>At E-Alchemy, accessible from http://localhost/E-Alchemy/, one of our main priorities is the privacy of our visitors.
    This Privacy Policy document contains types of information that is collected and recorded by E-Alchemy and how we
    use it.</p>
...
<p>E-Alchemy follows a standard procedure of using log files. These files log visitors when they visit websites. All
...
<p>Like any other website, E-Alchemy uses 'cookies'. These cookies are used to store information including visitors'
...
<p>For more general information on cookies, please read the "What Are Cookies" article on <a
            href="https://www.privacypolicyonline.com/what-are-cookies/">Cookie Consent website</a>.</p>
...
<P>You may consult this list to find the Privacy Policy for each of the advertising partners of E-Alchemy.</p>

<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
    their respective advertisements and links that appear on E-Alchemy, which are sent directly to users' browser. They
...
<p>Note that E-Alchemy has no access to or control over these cookies that are used by third-party advertisers.</p>

<h2>Third Party Privacy Policies</h2>

<p>E-Alchemy's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
...
<p>E-Alchemy does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
...
<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
    the information that they shared and/or collect in E-Alchemy. This policy is not applicable to any information
